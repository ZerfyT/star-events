...
public class RegisterModel : PageModel
{
    ...
    public async Task<IActionResult> OnPostAsync(string returnUrl = null)
    {
        ...
        if (ModelState.IsValid)
        {
            ...
            var user = CreateUser(); // Updated to use CreateUser method with ApplicationUser
            ...
            if (result.Succeeded)
            {
                ...
                {
                    _logger.LogWarning("Failed to assign {Role} role to user: {Errors}", "Customer",
                        string.Join(", ", roleAssignmentResult.Errors.Select(e => e.Description)));
    ...
    private ApplicationUser CreateUser() // Updated return type to ApplicationUser
    {
        try
        {
    ...
    private IUserEmailStore<ApplicationUser> GetEmailStore() // Updated to ApplicationUser
    {
