...
namespace star_events.Controllers
{
    public class PromotionController : Controller
    {
        ...
        public IActionResult Create([Bind("PromotionID,EventID,PromoCode,DiscountType,DiscountValue,StartDate,EndDate,IsActive")] Promotion promotion)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult Edit(int id, [Bind("PromotionID,EventID,PromoCode,DiscountType,DiscountValue,StartDate,EndDate,IsActive")] Promotion promotion)
        {
